...
class LoCoBotCamera(SimpleCamera):
    ...
    def get_pan(self):
        ...
        :rtype: float
        """
        raise NotImplementedError('get_pan')
    ...
    def get_tilt(self):
        ...
        :rtype: float
        """
        raise NotImplementedError('get_tilt')
    ...
    def set_pan(self, pan, wait=True):
        ...
        :type wait: bool
        """
        raise NotImplementedError('set_pan')
    ...
    def set_tilt(self, tilt, wait=True):
        ...
        :type wait: bool
        """
        raise NotImplementedError('set_tilt')
    ...
    def set_pan_tilt(self, pan, tilt, wait=True):
        ...
        :type wait: bool
        """
        raise NotImplementedError('set_pan_tilt')
